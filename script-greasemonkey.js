...
setTimeout(async function() {
  ...
  if(window.location.href.startsWith("https://www.infojobs.net/candidate/application/index.xhtml?")) {
    ...
    // 2. Si tiene el botón de inscribirse, darle automático:
  	try { return document.querySelector("#candidate_application_bottom").click() } catch(error) {}
    ...
    if(window.location.href.startsWith("https://www.infojobs.net/jobsearch/search-results/list.xhtml?")) {
